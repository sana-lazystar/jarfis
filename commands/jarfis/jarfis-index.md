...
> Do not edit manually. Last updated: 2026-05-11 | Version: 4.11.0
...
└── jarfis/
    ...
    ├── agent-composition.yaml     # v4 agent composition spec — persona + skills + context (ADR-17; consumed by `jarfis_cli.py compose`). v4.10 Stage 2 — 10개 IA-relevant agent 에 `docs/discovery/ia/manifest.json` inject (PO+strategist 는 `.baseline/manifest.json` 추가; 전부 optional+recommended, D7 L1 layer)
