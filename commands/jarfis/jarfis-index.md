...
> Do not edit manually. Last updated: 2026-05-11 | Version: 4.10.0
...
- `~/.claude/scripts/tests/` — pytest test directory (29 test modules covering all jarfis/ modules; run via `python3 -m pytest ~/.claude/scripts/tests/ -v --tb=short`; 864 tests passing @ v4.9.0)
  ...
  - `test_state.py` · `test_verify.py`-family (`test_gate_check.py`, `test_phase_verify.py`) · `test_tmux_claude.py` · `test_trace.py` · `test_compose_warnings.py` · `test_compose_ia.py` (v4.10 Stage 2 — IA inject 검증)
