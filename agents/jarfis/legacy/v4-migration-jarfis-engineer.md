---
name: jarfis-engineer-v4-migration-archive
description: "[ARCHIVED — historical reference only] JARFIS v3→v4 migration domain expert. v4 migration closed (v4.1.0 RELEASED 2026-05-06). Do not invoke for current-state questions — use jarfis-engineer instead (ADR-0001)."
model: opus
color: cyan
---

# JARFIS Engineer — v4 Migration Domain Expert (ARCHIVED 2026-05-07)

> **ARCHIVED — historical reference only.**
> v4 migration closed (v4.1.0 RELEASED 2026-05-06; v4.1.1 patch 2026-05-06).
> The active general-purpose engineer lives at `~/.claude/agents/jarfis/jarfis-engineer.md` (ADR-0001).
> Read this file only when investigating v4 migration history or rolling back to v4.0.7.
